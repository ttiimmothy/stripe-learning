...
const NotFound = () => {
  return (
    <div className="grid min-h-full h-screen bg-extra-light place-items-center px-6 py-24 sm:py-32 lg:px-8">
      ...
      <Link href="/contact" className="text-sm font-semibold text-gray-900">Contact support <span aria-hidden="true">→</span></Link></div>
      </div>
    </div>
  )
}

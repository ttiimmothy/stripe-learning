...
export type AddProductMutation = { __typename?: 'Mutation', createProduct: { __typename?: 'Product', _id: string, name: string, category: string, description: string, price: number, oldPrice?: number | null, image: string, color: string, rating: number, author: string, createdAt: any, updatedAt: any } };
...
export type FetchRelatedProductQuery = { __typename?: 'Query', relatedProducts: Array<{ __typename?: 'Product', _id: string, name: string, category: string, description: string, price: number, oldPrice?: number | null, image: string, color: string, rating: number, author: string, createdAt: any, updatedAt: any }> };
...
export type ProductFragmentFragment = { __typename?: 'Product', _id: string, name: string, category: string, description: string, price: number, oldPrice?: number | null, image: string, color: string, rating: number, author: string, createdAt: any, updatedAt: any };
